...
var LineChart = function (_a) {
    ...
    var _b = React__default["default"].useState({ labels: [], datasets: [] }), _data = _b[0], setData = _b[1];
    React__default["default"].useEffect(function () {
        var labels = data.map(function (item) { return item.label; });
        var datasets = [{ label: title, borderColor: 'rgb(255, 99, 132)', backgroundColor: 'rgba(255, 99, 132, 0.5)', data: data.map(function (item) { return item.value; }) }];
        setData({ labels: labels, datasets: datasets });
    }, [data]);
    return (React__default["default"].createElement("div", null,
        React__default["default"].createElement(Line, { options: options, data: _data })));
};
